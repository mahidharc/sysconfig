...
# Automate mounting USB and CD/DVD
alias usb='sudo mount /dev/sdc ~/usb'
alias uusb='sudo umount ~/usb'
alias dvd='sudo mount -t iso9660 /dev/sr0 ~/dvd'
alias udvd='sudo umount ~/dvd'
